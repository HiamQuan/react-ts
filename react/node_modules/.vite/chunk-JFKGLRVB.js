import {
  ...
  require_classnames,
  require_react_is
} from "./chunk-W653YH5P.js";
import {
  _extends,
  init_extends
} from "./chunk-QAGM3GUF.js";
import {
  require_react_dom
} from "./chunk-GN7RXMUE.js";
import {
  require_react
} from "./chunk-TS2HEN5F.js";
import {
  __commonJS,
  __esm,
  __export,
          ...
          case 13:
            ...
            if (_context2.t0.errors) {
              result = _context2.t0.errors.map(function(_ref4, index) {
                ...
                return React4.isValidElement(message) ? React4.cloneElement(message, {
...
var import_regenerator, React4, AsyncValidator;
...
var init_useStepQueue = __esm({
  "node_modules/rc-motion/es/hooks/useStepQueue.js"() {
    ...
    useStepQueue_default = function(status, callback) {
      var _useState = useState3(STEP_NONE), _useState2 = _slicedToArray(_useState, 2), step = _useState2[0], setStep = _useState2[1];
...
var React15, import_react3, useDomMotionEvents_default;
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var _useState = useState3(), _useState2 = _slicedToArray(_useState, 2), asyncVisible = _useState2[0], setAsyncVisible = _useState2[1];
  var _useState3 = useState3(STATUS_NONE), _useState4 = _slicedToArray(_useState3, 2), status = _useState4[0], setStatus = _useState4[1];
  var _useState5 = useState3(null), _useState6 = _slicedToArray(_useState5, 2), style2 = _useState6[0], setStyle = _useState6[1];
  var mountedRef = (0, import_react4.useRef)(false);
  var deadlineRef = (0, import_react4.useRef)(null);
  var cacheElementRef = (0, import_react4.useRef)(null);
...
var React18, import_react5, import_classnames, CSSMotion_default;
...
var init_CSSMotionList = __esm({
  "node_modules/rc-motion/es/CSSMotionList.js"() {
    ...
    init_motion();
    init_diff();
    _excluded4 = ["component", "children", "onVisibleChanged"];
    _excluded22 = ["status"];
...
var React20, import_react6, import_react_dom2, import_classnames2, Notice;
...
var React22, import_react7, import_react_dom3, import_classnames3, seed, now, Notification, Notification_default;
var init_Notification = __esm({
  "node_modules/rc-notification/es/Notification.js"() {
    ...
    Notification.newInstance = function newNotificationInstance(properties, callback) {
      var _ref6 = properties || {}, getContainer = _ref6.getContainer, props = _objectWithoutProperties(_ref6, ["getContainer"]);
      ...
      import_react_dom3.default.render(React22.createElement(Notification, _extends({}, props, {
        ref
      })), div);
    };
...
//# sourceMappingURL=chunk-JFKGLRVB.js.map
